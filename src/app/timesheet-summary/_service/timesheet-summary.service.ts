...
export class TimesheetSummaryService {
    ...
    //   getAllSummaryData() {
    //     return this._http.get("https://clockgeo.geoplanph.com/assets/data/timesheet-summary.json");
    //
    ...
    getFilteringYearAndWeek(week_no: string, Year: string): Observable<TimesheetSummaryModel[]> {
        return this._http.get<TimesheetSummaryModel[]>(
