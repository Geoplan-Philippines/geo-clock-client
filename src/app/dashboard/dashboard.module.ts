...
@NgModule({
    declarations: [DashboardComponent, WfhTrackingComponent, ProjectChargingGeoplanComponent, ProjectManhoursComponent],
    imports: [CommonModule, SharedModule, MaterialModule, NgApexchartsModule, HttpClientModule, BrowserModule],
