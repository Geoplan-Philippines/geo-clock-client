                ...
                fetch(nominatimUrl)
                    ...
                    .then((data) => {
                        ...
                        this.attendanceService
                            .updateAllDataInitialTimeOut(user, date, statuses, dataAttendance)
                            .subscribe({
                                next: (response: any) => {
            ...
            if (currentUser) {
                ...
                this.attendanceService.getAllAttendanceData(date).subscribe((res: any) => {
                    ...
                    if (isOwner) {
                        ...
                        const updatedFilteredAttedance = filteredattendance.map(
    ...
    loadFilteringWithDate() {
        ...
        this.attendanceService.getAllemployeetData().subscribe((employeeData: any) => {
            ...
            if (currentUser) {
                ...
                this.attendanceService
                    .getAllAttendanceData(this.filterDate)
                    .subscribe((res: any) => {
                        const ds = res;
